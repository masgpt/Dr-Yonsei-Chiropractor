...
const NotFoundDesktop: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] text-center px-10">
      ...
      <Link 
        to="/" 
        className="inline-flex items-center justify-center h-14 px-10 rounded-xl bg-primary hover:bg-orange-600 text-white font-bold transition-all shadow-lg text-lg"
      >
        {t('notFound.cta')}
      </Link>
    </div>
