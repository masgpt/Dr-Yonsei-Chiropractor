...
const ReviewsDesktop: React.FC = () => {
  ...
  return (
    <>
      ...
      />
      {/* Hero Section */}
      <section className="w-full bg-white dark:bg-slate-900 py-12 px-8 border-b border-slate-100 dark:border-slate-800">
        ...
        <div className="grid grid-cols-3 gap-6">
          {reviews.map((review) => (
            <div 
              ...
              className="flex flex-col gap-4 p-6 bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 hover:shadow-md hover:border-primary/30 hover:scale-[1.01] transition-all duration-300 h-full cursor-pointer group"
            >
      ...
      <section className="w-full px-8 py-8 mb-8">
        <div className="max-w-[1280px] mx-auto bg-slate-900 dark:bg-slate-800 rounded-2xl p-12 text-center shadow-xl relative overflow-hidden">
