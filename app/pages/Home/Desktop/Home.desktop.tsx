      ...
      <section className="py-20 bg-white dark:bg-[#0a0f14] relative overflow-hidden" aria-labelledby="reviews-heading">
        ...
        <div className="max-w-[1280px] mx-auto px-10">
          ...
          <div className="grid grid-cols-3 gap-8">
            {reviews.map((rev) => (
              <Link key={rev.id} to="/reviews" className="bg-slate-50 dark:bg-slate-900/50 p-8 rounded-[32px] border border-slate-100 dark:border-slate-800 relative hover:shadow-2xl transition-all group !text-inherit">
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="flex w-12 h-12 rounded-2xl bg-primary/10 text-primary items-center justify-center font-black text-sm">
                      {rev.initials}
                    </div>
                    <div>
      ...
      <section className="py-20 bg-slate-50 dark:bg-slate-950/50 border-t border-slate-100 dark:border-slate-900" aria-labelledby="location-heading">
        <div className="max-w-[1280px] mx-auto px-10">
          <div className="grid grid-cols-12 gap-20">
            ...
            <div className="col-span-7 h-auto w-full bg-slate-200 dark:bg-slate-800 rounded-[40px] overflow-hidden shadow-2xl relative border-8 border-white dark:border-slate-800">
              <iframe 
