...
const SubluxationMobile: React.FC = () => {
    ...
    <>
      ...
      <section className="relative w-full h-[120px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 w-full px-4 text-center">
          <h1 className="text-2xl font-black text-white leading-tight drop-shadow-lg uppercase">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-sm dark:prose-invert text-slate-600 dark:text-slate-300 max-w-none">
            ...
            <div className="bg-slate-50 dark:bg-slate-800 p-6 rounded-2xl border border-slate-100 dark:border-slate-700 mb-10">
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-4">{t('techniques.subluxation.silent.title')}</h3>
            ...
            <p className="mb-10">{t('techniques.subluxation.p4')}</p>

            <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-4">{t('techniques.subluxation.cause.title')}</h3>
...
export default SubluxationMobile;
